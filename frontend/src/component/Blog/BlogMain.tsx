...
const BlogMain = () => {
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>Solar Energy Insights & Blog | eeoxoe Energy</title>
        ...
        {/* Canonical */}
        <link rel="canonical" href="https://eeoxoe.in/Knowledge/" />

        {/* Open Graph */}
        <meta property="og:title" content="Solar Energy Blog | eeoxoe Energy Insights" />
        ...
        <meta property="og:url" content="https://eeoxoe.in/Knowledge/" />
        <meta property="og:type" content="website" />

        {/* OG Image */}
        <meta property="og:image" content="https://eeoxoe.in/solar-blog.jpg" />
