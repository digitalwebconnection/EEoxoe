      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 grid items-start gap-10 lg:grid-cols-2">
          ...
          >
            ...
            <motion.h2
              variants={item}
              className="mb-3 text-4xl font-extrabold leading-[1.1] md:text-[49px]"
            >
              Creating User Interfaces That{" "}
              <span className="text-[#ffd740]">Inspire</span>& Engage
            </motion.h2>
          </motion.div>
          ...
          >
            <motion.p variants={item} className="text-[#262755]/70">
              We design user interfaces that inspire engagement, simplify interaction, and deliver seamless digital experiences that users enjoy and trust.
            </motion.p>
