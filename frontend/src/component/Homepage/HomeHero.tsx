    ...
    <section className="relative overflow-hidden px-4 py-8 sm:px-6 lg:px-8 ">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <motion.div
          ...
          animate="animate"
          className="absolute -top-24 -right-24 h-105 w-105 rounded-full bg-linear-to-br from-[#E8F4FF] to-[#F7E9FF] blur-3xl opacity-80"
        />
        <motion.div
          variants={blobVariants}
          animate="animate"
          transition={{ delay: 2 }}
          className="absolute -bottom-24 -left-24 h-105 w-105 rounded-full bg-linear-to-tr from-[#FFF0E1] to-[#EAF7FF] blur-3xl opacity-70"
        />
      </div>
      ...
      <div className="mx-auto grid max-w-7xl items-center py-12 gap-12 md:grid-cols-2">
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show">
          ...
          <motion.h1
            variants={itemVariants}
            className="mb-4 font-extrabold leading-[1.1] text-[#262755] text-3xl sm:text-4xl md:text-[49px]"
          >
            Software Development & <br />
            <span className="text-[#FDD53D]">Programming Company</span><br />
          ...
          <motion.p
            variants={itemVariants}
            className="mb-8 max-w-2xl text-lg text-slate-600"
          >
            EXOCHOS is a custom software development company delivering scalable, high-performance digital solutions through modern programming practices, innovative technologies, and business-focused execution.</motion.p>
          ...
          >
            <button
              ...
              className="h-12 rounded-full bg-[#262755] px-6 text-sm font-semibold text-white transition-all duration-300 hover:scale-110 hover:bg-[#ffd740] hover:text-[#262755] hover:shadow-lg hover:shadow-[#ffd740]/50">
              Get Started
            </button>
