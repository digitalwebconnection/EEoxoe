    ...
    <section className="relative overflow-visible bg-white px-4 py-20 text-[#262755] sm:px-6 lg:px-8 md:py-32">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <motion.h2
            variants={item}
            className="mb-3 text-4xl font-extrabold md:text-[49px]"
          >
            Client Success Stories & {" "}
            <span className="text-[#ffd740]">Testimonials</span>
          </motion.h2>
          <motion.p
            variants={item}
            className="mx-auto max-w-7xl text-lg text-[#262755]/70"
          >
            Trusted by clients for quality, performance, and consistent results across diverse digital projects.
          </motion.p>
          <motion.div
            variants={item}
