      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-10 text-center">
          <motion.h2
            ...
            transition={{ type: "spring", stiffness: 110, damping: 14 }}
            className="mb-4 mx-auto max-w-5xl text-4xl font-bold md:text-[49px]"
            style={{ color: "#262755" }}
          >
           Smart Digital Solutions Delivering Proven Results.
          </motion.h2>
          ...
          >
           Turning advanced technology into measurable success for growing businesses.
          </motion.p>
        </div>
