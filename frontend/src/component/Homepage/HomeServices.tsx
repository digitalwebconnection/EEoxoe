...
const services: Service[] = [
  {
    ...
    description:
      "Scalable, secure web applications for growth.",
    image:
  ...
  },
  {
    ...
    description:
      "Powerful mobile apps with seamless experience.",
    image:
  ...
  },
  {
    ...
    title: " Odoo",
    description:
      "Custom Odoo ERP for smarter operations.",
    image:
  ...
  },
  {
    ...
    description:
      "AI integration for efficient digital systems.",
    image:
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-5  text-center">
          <motion.h2
            ...
            transition={{ type: "spring", stiffness: 90, damping: 12 }}
            className="mb-4 max-w-5xl mx-auto text-4xl font-extrabold text-[#262755] md:text-[49px]"
          >
            Custom Software Solutions for Complex Business Challenges
          </motion.h2>
          ...
          <motion.p
            ...
            className="mx-auto max-w-7xl text-lg text-[#555]"
          >
           We design and develop custom web, mobile, ERP, and AI-powered solutions tailored to solve complex business challenges. Our focus is on building reliable, scalable systems that deliver measurable results and adapt as your business evolves.
          </motion.p>
        </div>
