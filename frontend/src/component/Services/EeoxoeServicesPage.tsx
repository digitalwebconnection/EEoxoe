...
const SERVICES = [
  {
    ...
    image:
      "https://www.webhopers.com/wp-content/uploads/2016/04/eCommerce-Web-Development-Services.jpg",
    addons: [
      "Custom Storefronts",
  ...
  },
  {
    ...
    description:
      "Enterprise-grade Odoo ERP solutions to streamline operations, automate workflows, and scale business growth.",
    image:
      "https://sdlccorp-web-prod.blr1.digitaloceanspaces.com/wp-content/uploads/2024/11/19182858/Odoo-ERP-Development-1.png",
    addons: [
      "Implementation",
      "Integrations",
      "Customization",
  ...
  },
  {
    ...
    description:
      "Custom website development and responsive design solutions to help businesses create a powerful online presence.",
    image:
    ...
    <div className="bg-white text-gray-900 scroll-smooth">
      <div ref={servicesWrapperRef} className="relative">
        ...
        <motion.div
          ...
          className="fixed hidden md:block left-1/5 z-40"
            ...
            <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div className={index % 2 === 0 ? "lg:order-2" : "lg:order-1"}>
                <img
                  src={service.image}
                  alt={service.title}
                  className="rounded-2xl w-full h-70 shadow-lg"
                />
              </div>
